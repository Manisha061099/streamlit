...
st.markdown('<span style="color:yellow font-size:50px">TradeWise Student Data</span>',unsafe_allow_html=True)
...
if st.sidebar.button("scatter plot"):
    ...
    plt.xlabel("sl",fontsize=20)
    plt.ylabel("Trade",fontsize=20)
    st.pyplot(fig)
